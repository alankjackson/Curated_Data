...
foo <- DF_Impute_Deaths_County[DF_Impute_Deaths_County$Condition=="Accidental Discharge of Firearms",]

sum(foo$Impute_deaths, na.rm=TRUE)

sum(foo$Deaths, na.rm=TRUE)
sum(is.na(foo$Deaths))
