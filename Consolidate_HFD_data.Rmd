...
Delta_x_lft <- (coords[1,4]-coords[2,4])[[1]]/(71-1)
Delta_y_lft <- (coords[1,5]-coords[2,5])[[1]]/(71-1)

#   259E to 699W, (81,1) to (81,71)  Right vertical line

Delta_x_rgt <- (coords[3,4]-coords[4,4])[[1]]/(71-1)
Delta_y_rgt <- (coords[3,5]-coords[4,5])[[1]]/(71-1)
