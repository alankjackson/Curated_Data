...
Old_street <- c("MARTIN LUTHER KING$", "^F M ", "^F.M. ",
                "^JOHN A$" ,"^AVE " ,"^H R$" ,"^T K C$", " SQ$",
                "^ST ")
New_street <- c("MARTIN LUTHER KING JR", "FM ", "FM ", 
                "JOHN-A", "AVENUE ", "H AND R", "TKC", " SQUARE",
                "SAINT ")

dfnew[dfnew$New_street=="MARTIN LUTHER KING$",]$New_street <- "MARTIN LUTHER KING JR"
