...
for (i in 2:96){ # top row
  Dx <- abs(Poly[i,]$X - Poly[ij(2,1+i),]$X)
  Dy <- abs(Poly[i,]$Y - Poly[ij(2,1+i),]$Y)
  print(paste(Dx, ",", Dy))
  Poly[i,]$llx <- Poly[i,]$X - Dx/2
  Poly[i,]$lly <- Poly[i,]$Y - Dy/2
  Poly[i,]$lrx <- Poly[i,]$X + Dx/2
  Poly[i,]$lry <- Poly[i,]$Y - Dy/2
  Poly[i,]$urx <- Poly[i,]$X + Dx/2
  Poly[i,]$ury <- Poly[i,]$Y + Dy/2
  Poly[i,]$ulx <- Poly[i,]$X - Dx/2
  Poly[i,]$uly <- Poly[i,]$Y + Dy/2
  Poly[i,]$Poly <- list(matrix(c(Poly[i,]$lrx, Poly[i,]$lry,
                          Poly[i,]$llx, Poly[i,]$lly,
                          Poly[i,]$ulx, Poly[i,]$uly,
                          Poly[i,]$urx, Poly[i,]$ury,
                          Poly[i,]$lrx, Poly[i,]$lry),
                          ncol=2, nrow=5, byrow=TRUE))
